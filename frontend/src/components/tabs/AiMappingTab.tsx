  ...
  return (
    <div className="space-y-4">
      <div className="text-base text-[#57423c] space-y-1">
        ...
        <p>또는 채울 내용을 직접 붙여넣을 수도 있습니다. <span className="text-sm text-[#57423c]/70">Google AI 사용 · 학습에 미사용</span></p>
      </div>
      {!isAnalyzed && (
      ...
      <textarea
        className="w-full border border-[#93C5FD]/400 rounded-xl p-3 text-sm resize-y focus:outline-none focus:border-[#1E40AF]/40 bg-white transition-colors"
        rows={2}
