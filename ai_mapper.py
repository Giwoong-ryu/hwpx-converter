...
2. __N 접미사 셀은 사용자 내용에 실제로 존재하는 N번째 항목만 채우세요 (날짜순, 오래된 것 → __1).
   - 사용자 내용에 N번째 항목이 없으면 해당 __N 키는 JSON에서 생략하세요.
   - 같은 항목을 __2, __3에 복사하는 것은 절대 금지입니다.
   예) 경력이 1개 → 회사명__1, 기간__1, 업무내용__1만 채우고 __2, __3은 생략.
       경력이 2개 → __1, __2만 채우고 __3은 생략.
