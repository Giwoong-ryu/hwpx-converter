...
## 7TC 기준선 (2026-04-13 2차 갱신)

| TC | 양식 | 정확도 | 등급 | 상태 |
|----|------|--------|------|------|
| TC-01 | 세금계산서 | 3-5/10 | D | 구조적 한계 (병합 셀) |
| TC-02 | 견적서 | 8/10 | B | 안정 (복수 run 확인) |
| TC-03 | 정부공문 | 5/10 | D | COM 환경 있을 때 critical 실패 (양식 구조 한계) |
| TC-04 | 사업제안서 | 5-8/10 | B~C | AI 변동성 (인물 혼동, 필드 매핑 변동) |
| TC-05 | 표준근로계약서 | 4/10 | D | 구조적 한계 (단락 빈칸) |
| TC-06 | 납품확인서 | 1-3/10 | D | 구조적 한계 (양식 필드 부재) |
| TC-07 | 상담일지 | 5-7/10 | C | AI 변동성 (개선: Rule 14 학년단축형 + field8 스펙 완화) |
